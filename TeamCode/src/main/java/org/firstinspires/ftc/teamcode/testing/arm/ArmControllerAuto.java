...
import org.firstinspires.ftc.teamcode.ctrl.TrapezoidalMotionProfile;

public class ArmControllerAuto {
    ...
    public static class ElbowParams {
        //Auto mode Variable
        public int autoUpdateVariable = 1;
    ...
    public void update(ElapsedTime runtime, Gamepad gamepad1) {

        // update triggers
        homeTrigger.update(gamepad1.x||autoUpdateVariable == 1);
        dropTrigger.update(gamepad1.y||autoUpdateVariable == 2);
        pickTrigger.update(gamepad1.b||autoUpdateVariable == 3);
